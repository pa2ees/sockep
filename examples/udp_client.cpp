...
int main(int argc, char *argv[])
{
    ...
    if (argc > 2)
    {
        client = std::unique_ptr<sockep::IClientSockEP>(sockep::SockEPFactory::createUdpClientSockEP(argv[1], strtol(argv[2], NULL, 10)));
    }
    else
    {
        client = std::unique_ptr<sockep::IClientSockEP>(sockep::SockEPFactory::createUdpClientSockEP("127.0.0.1", 5678));
    }
